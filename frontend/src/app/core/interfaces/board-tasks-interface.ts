 ...
 * @property dueDate - The due date as an ISO date string.
 ...
 * @property createdAt - ISO timestamp when the task was created.
 * @property updatedAt - (Optional) ISO timestamp of the last update.
 ...
 * @property lastChanged - (Optional) ISO timestamp indicating when the settings were last changed.
 */
