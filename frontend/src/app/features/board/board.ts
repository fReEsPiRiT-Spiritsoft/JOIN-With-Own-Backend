...
export class Board implements OnInit, OnDestroy {
  ...
  /**
   * Loads tasks from the API and subscribes to updates.
  ...
  /**
   * Handles task creation by saving to the API.
  ...
  /**
   * Handles task deletion by removing via the API.
  ...
  /**
   * Handles subtask toggle by updating the task via the API.
   ...
   * Updates the task status via the API.
   * 
